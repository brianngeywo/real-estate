...
class PhoneAuthModel {
  ...
  factory PhoneAuthModel.fromMap(Map<String, dynamic> map) {
    ...
    return PhoneAuthModel(
      phoneAuthModelState: PhoneAuthModelState.values[map['phoneAuthModelState']],
  ...
  factory PhoneAuthModel.fromJson(String source) => PhoneAuthModel.fromMap(json.decode(source));
  ...
  @override
  int get hashCode {
    return phoneAuthModelState.hashCode ^ verificationId.hashCode ^ verificationToken.hashCode ^ uid.hashCode;
  }
}
