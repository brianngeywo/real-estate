...
class MyPropertiesList extends StatelessWidget {
  MyPropertiesList({Key key, this.properties_data, this.index}) : super(key: key);
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5),
                        InkWell(
                          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => UpdateProperty())),
                          child: Container(
                            height: 36,
                            width: 36,
                            decoration: BoxDecoration(
