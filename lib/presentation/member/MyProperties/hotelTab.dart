...
import 'package:Realify/presentation/member/MyProperties/hotelList.dart';
...
class HotelTabBar extends StatefulWidget {
  const HotelTabBar({Key key}) : super(key: key);

  @override
  _HotelTabBarState createState() => _HotelTabBarState();
}
        ...
        if (snapshot.data == null || snapshot.data.docs.isEmpty) {
          return Center(
            child: SizedBox(
              height: 50,
              // width: 50,
              child: Text("You haven't posted any hotel",
                  style: TextStyle(
