...
class AddHotelListing extends StatefulWidget {
  static const id = 'add_hotel_listing';
  AddHotelListing({
    Key key,
    // @required this.propertyFields = const [],
  }) : super(key: key);
  @override
  _AddHotelListingState createState() => _AddHotelListingState();
}

class _AddHotelListingState extends State<AddHotelListing> {
          ...
          listener: (context, state) {
            ...
            if (state is UploadedImagesState) {
              ...
              BlocProvider.of<AddPropertyBloc>(context).add(
                UploadHotelEvent(
                    county: county,
                    subCategory: selectedPropertyType,
