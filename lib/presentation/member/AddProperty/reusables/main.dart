...
convertListToMap(proposal, county, category, subCategory, price, bedrooms, locality, propertyName, description,
    rentalFrequency, area, areaUnit, phone,bathrooms, BuildContext context) {
  String message = "";
...
class _BathroomtypeState extends State<Bathroomtype> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    BlocProvider.of<AddPropertyBloc>(context).add((SelectedBathroomEvent(index: _tabController.index, bathroom: title)));
  }
