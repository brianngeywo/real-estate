import 'package:Realify/presentation/member/BlogDetails/main.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontFamily: FontConfig.bold, fontSize: Sizeconfig.large, color: ColorConfig.dark),
                ),
              ),
              SizedBox(
                height: 10,
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Text(
                        "" + blog_data[index]["btn"],
                        style: TextStyle(
                            fontFamily: FontConfig.regular, fontSize: Sizeconfig.small, color: ColorConfig.yellow),
                      ),
                    ),
                    SizedBox(
                      width: 2,
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontFamily: FontConfig.regular, fontSize: Sizeconfig.tiny, color: ColorConfig.greyLight),
                      ),
                    ),
                  ],
                ),
